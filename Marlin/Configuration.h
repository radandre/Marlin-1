...
#define STRING_VERSION_CONFIG_H __DATE__ "31/05/2013" __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "SHAREBOT BI" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {94.139704,94.139704,400,96.2753}  // default steps per unit for ultimaker
