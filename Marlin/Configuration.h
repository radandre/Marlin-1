...
#define STRING_VERSION_CONFIG_H __DATE__ "02/09/2013" __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "SHAREBOT NG" //Who made the changes.
