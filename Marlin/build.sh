...
<firmware>
        ...
        <link board="0" ext="1" bed="1" lang="$lang_code">
                http://www.sharebot.eu/downloads/firmware/fw-H$hw-L$lang-$VERSION_$DATE-11.hex
        </link>
        <link board="0" ext="2" bed="1" lang="$lang_code">
                http://www.sharebot.eu/downloads/firmware/fw-H$hw-L$lang-$VERSION_$DATE-21.hex
        </link>
</firmware>"
END
   done
